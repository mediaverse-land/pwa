    ...
    <div className="flex flex-col items-stretch gap-2 lg:gap-6 sticky top-0 left-0 w-full z-30">
      ...
      <div className="rounded-lg grid grid-flow-col grid-rows-1 bg-[#0E0E1280] backdrop-blur-md mx-4 lg:mx-10">
        {ExploreSectionNavs.slice(0, 5).map((tab) => (
          ...
          >
            <div
              className={`py-3 lg:py-2 w-fit h-full flex items-center justify-center px-2 transition-all duration-700 after:content-[''] relative after:absolute after:bg-[#597AFF] after:rounded-full after:left-0 after:bottom-0 ${
                activeTab === tab.name
