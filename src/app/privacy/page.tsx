    ...
    return (
        <div className="w-full flex mt-36 pb-16 justify-center px-4 min-h-screen">
            <div className="sm:w-6/12 w-full flex flex-col">
                ...
                <article className="text-white w-full prose lg:prose-xl prose-h1:text-white prose-h2:text-white prose-h3:text-white prose-h4:text-white prose-strong:text-white" dangerouslySetInnerHTML={{ __html: privacyData.content }}></article>
            </div>
        </div>);
}
