const Privacy = () => {
    return (<div className="w-full flex mt-36 pb-16 justify-center px-4">
        <div className="sm:w-6/12 w-full flex flex-col">
            <h1 className="text-white text-4xl mt-8 sm:mt-0">Privacy</h1>
            <p className="text-white w-full  mt-6">The Instagram Basic Display API allows users of your app to get basic profile information, photos, and videos in their Instagram accounts.
            ...
            <ul className="text-white list-disc text-xs w-full ">
