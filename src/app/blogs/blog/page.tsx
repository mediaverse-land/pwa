...
const Blog = () => {
    return (<div className="w-full flex justify-center mt-36 space-x-10">
        ...
        <div>
            ...
            <p className="text-white w-[650px]">The Instagram Basic Display API allows users of your app to get basic profile information, photos, and videos in their Instagram accounts.
            ...
            <ul className="text-white list-disc text-xs w-[650px]">
