...
const Blogs = () => {
    return (<div className=" mt-28 flex flex-col items-center">
        ...
        <div className="flex flex-wrap w-full justify-center sm:justify-between sm:w-8/12 items-center mt-6">
            <div className="flex flex-col py-4 px-4 border border-blue-800 rounded-2xl mt-8">
